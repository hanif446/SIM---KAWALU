...
@section('breadcrumbs')
    {{Breadcrumbs::render('dashboard_pegawai_create')}}
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_nama" value="{{old('nama_pegawai')}}" name="nama_pegawai" type="text" class="form-control @error('nama_pegawai') is-invalid @enderror" placeholder="Input Nama Pegawai" />
                                <!-- error message -->
                                @error('nama_pegawai')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_tempat_lhr" value="{{old('tempat_lhr')}}" name="tempat_lhr" type="text" class="form-control @error('tempat_lhr') is-invalid @enderror" placeholder="Input Tempat Lahir" />
                                <!-- error message -->
                                @error('tempat_lhr')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_tgl_lhr" value="{{old('tgl_lhr')}}" name="tgl_lhr" type="date" class="form-control @error('tgl_lhr') is-invalid @enderror" placeholder="Input Tanggal Lahir" />
                                <!-- error message -->
                                @error('tgl_lhr')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_no_hp" value="{{old('no_hp')}}" name="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror" placeholder="Input No HP" />
                                <!-- error message -->
                                @error('no_hp')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if (old('jabatan'))
                                    <option value="{{ old('jabatan')->id }}" selected>{{ old('jabatan')->nama_jabatan }}</option>
                                @endif
                                </select>
                                <!-- error message -->
                                @error('jabatan')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if (old('golongan_gaji'))
                                    <option value="{{ old('golongan_gaji')->id }}" selected>{{ old('golongan_gaji')->golongan }}</option>
                                @endif
                                </select>
                                <!-- error message -->
                                @error('golongan_gaji')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_pendidikan" value="{{old('pendidikan')}}" name="pendidikan" type="text" class="form-control @error('pendidikan') is-invalid @enderror" placeholder="Input Pendidikan"/>
                                <!-- error message -->
                                @error('pendidikan')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_jurusan" value="{{old('jurusan')}}" name="jurusan" type="text" class="form-control @error('jurusan') is-invalid @enderror" placeholder="Input Jurusan" />
                                <!-- error message -->
                                @error('jurusan')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_diklat_pim" value="{{old('diklat_pim')}}" name="diklat_pim" type="text" class="form-control @error('diklat_pim') is-invalid @enderror" placeholder="Input Diklat Pimpinan"/>
                                <!-- error message -->
                                @error('diklat_pim')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_thn_lulus" value="{{old('thn_lulus')}}" name="thn_lulus" type="text" class="form-control @error('thn_lulus') is-invalid @enderror" placeholder="Input Tahun Lulus" />
                                <!-- error message -->
                                @error('thn_lulus')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_pegawai_uker" value="{{old('uker')}}" name="uker" type="text" class="form-control @error('uker') is-invalid @enderror" placeholder="Input Unit Kerja"/>
                                <!-- error message -->
                                @error('uker')
                                  <span class="invalid-feedback">
                                    <strong>{{$message}}</strong>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if (old('user'))
                                    <option value="{{ old('user')->id }}" selected>{{ old('user')->email }}</option>
                                @endif
                                </select>
                                <!-- error message -->
                                @error('user')
