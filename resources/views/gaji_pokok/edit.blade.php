	         ...
	         <div class="card-body">
	            <form action="{{ route('gaji-pokok.update', ['gaji_pokok' => $gaji_pokok]) }}" method="POST">
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="bjb" type="text" class="form-control @error('bjb') is-invalid @enderror" value="{{ old('bjb', $potongan_gaji_pokok->bjb) }}" placeholder="Input BJB"/>
	                  @error('bjb')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="mukti_resik" type="text" class="form-control @error('mukti_resik') is-invalid @enderror" value="{{ old('mukti_resik', $potongan_gaji_pokok->mukti_resik) }}" placeholder="Input Mukti Resik"/>
	                  @error('mukti_resik')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="kopri" type="text" class="form-control @error('kopri') is-invalid @enderror" value="{{ old('kopri', $potongan_gaji_pokok->kopri) }}" placeholder="Input Kopri"/>
	                  @error('kopri')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="bjbs" type="text" class="form-control @error('bjbs') is-invalid @enderror" value="{{ old('bjbs', $potongan_gaji_pokok->bjbs) }}" placeholder="Input BJBS"/>
	                  @error('bjbs')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="al_madinah" type="text" class="form-control @error('al_madinah') is-invalid @enderror" value="{{ old('al_madinah', $potongan_gaji_pokok->al_madinah) }}" placeholder="Input Al-Madinah"/>
	                  @error('al_madinah')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
