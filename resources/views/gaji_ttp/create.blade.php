...
@section('breadcrumbs')
{{Breadcrumbs::render('dashboard_gaji_ttp_create')}}
@endsection
...
<div class="row">
	   <div class="col-md-12">
	      <div class="card">
	         <div class="card-body">
	            <form action="{{ route('gaji-ttp.store') }}" method="POST">
	            	@csrf
	               <!-- pegawai -->
	               ...
	               <div class="form-group">
	                  ...
	                  <input name="infak" type="text" class="form-control @error('infak') is-invalid @enderror" value="{{ old('infak') }}" placeholder="Input Infak"/>
	                  @error('infak')
		                  <span class="invalid-feedback">
		                 	<strong>
		                 		{{$message}}
